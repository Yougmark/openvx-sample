...
static vx_status VX_CALLBACK vxMinMaxLocKernel(vx_node node,
  ...
  if (num == 7) {
    ...
    return vxMinMaxLoc(input, minVal, maxVal, minLoc, maxLoc, minCount,
                       maxCount);
  }
  return VX_ERROR_INVALID_PARAMETERS;
}

static vx_status VX_CALLBACK vxMinMaxLocInputValidator(vx_node node,
                                                       vx_uint32 index) {
...
static vx_status VX_CALLBACK vxMinMaxLocOutputValidator(vx_node node,
                                                        vx_uint32 index,
...
vx_kernel_description_t minmaxloc_kernel = {
    ...
    vxMinMaxLocKernel,
    minmaxloc_kernel_params,
    dimof(minmaxloc_kernel_params),
    NULL,
