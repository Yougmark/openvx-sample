...
static vx_status VX_CALLBACK vxPhaseKernel(vx_node node,
...
static vx_status VX_CALLBACK vxPhaseInputValidator(vx_node node,
                                                   vx_uint32 index) {
...
static vx_status VX_CALLBACK vxPhaseOutputValidator(vx_node node,
                                                    vx_uint32 index,
