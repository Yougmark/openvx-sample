...
static vx_status VX_CALLBACK vxAddSubtractInputValidator(vx_node node,
                                                         vx_uint32 index) {
...
static vx_status VX_CALLBACK vxAddSubtractOutputValidator(
...
static vx_status VX_CALLBACK vxAdditionKernel(vx_node node,
...
vx_kernel_description_t add_kernel = {
    ...
    vxAdditionKernel,
    add_subtract_kernel_params,
    dimof(add_subtract_kernel_params),
    NULL,
...
static vx_status VX_CALLBACK vxSubtractionKernel(
