...
static vx_status VX_CALLBACK vxMedian3x3Kernel(vx_node node,
...
static vx_status VX_CALLBACK vxBox3x3Kernel(vx_node node,
                                            const vx_reference *parameters,
                                            vx_uint32 num) {
  vx_status status = VX_ERROR_INVALID_PARAMETERS;
  if (num == 2) {
...
static vx_status VX_CALLBACK vxGaussian3x3Kernel(vx_node node,
                                                 const vx_reference *parameters,
                                                 vx_uint32 num) {
  vx_status status = VX_ERROR_INVALID_PARAMETERS;
  if (num == 2) {
...
vx_kernel_description_t box3x3_kernel = {
    ...
    vxBox3x3Kernel,
    filter_kernel_params,
    dimof(filter_kernel_params),
    NULL,
