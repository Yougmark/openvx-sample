...
static vx_status VX_CALLBACK vxAbsDiffKernel(vx_node node,
...
static vx_status VX_CALLBACK vxAbsDiffInputValidator(vx_node node,
                                                     vx_uint32 index) {
  vx_status status = VX_ERROR_INVALID_PARAMETERS;
  if (index == 0) {
    vx_image input = 0;
...
static vx_status VX_CALLBACK vxAbsDiffOutputValidator(vx_node node,
                                                      vx_uint32 index,
