...
enum vx_kernel_extras_ext_e {
   ...
   * \note Use "org.khronos.extra.nonmaximasuppression" to \ref
   * vxGetKernelByName. \param [in] vx_image The magnitude image in
   * VX_DF_IMAGE_U8. \param [in] vx_image The phase image in VX_DF_IMAGE_U8.
  ...
  VX_KERNEL_EXTRAS_NONMAXSUPPRESSION_CANNY =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x0,
  ...
  VX_KERNEL_EXTRAS_LAPLACIAN_3x3 =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x1,
  ...
  VX_KERNEL_EXTRAS_SCHARR_3x3 =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x2,
  ...
  VX_KERNEL_EXTRAS_HARRIS_SCORE =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x3,
  ...
  VX_KERNEL_EXTRAS_SOBEL_MxN =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x4,
   ...
   * \param [out] vx_scalar The total number of non zero points in image
   * (optional) \ingroup group_vision_function_image_lister
   */
  VX_KERNEL_EXTRAS_IMAGE_LISTER =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x5,
  ...
  VX_KERNEL_EXTRAS_EUCLIDEAN_NONMAXSUPPRESSION_HARRIS =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x6,
  ...
  VX_KERNEL_EXTRAS_ELEMENTWISE_NORM =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x7,
  ...
  VX_KERNEL_EXTRAS_EDGE_TRACE =
      VX_KERNEL_BASE(VX_ID_KHRONOS, VX_LIBRARY_KHR_EXTRAS) + 0x8
};
...
vx_node vxSobelMxNNode(vx_graph graph, vx_image input, vx_scalar win,
