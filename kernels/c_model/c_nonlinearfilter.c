...
static vx_uint32 readMaskedRectangle_U8(
    const void *base, const vx_imagepatch_addressing_t *addr,
    const vx_border_t *borders, vx_df_image type, vx_uint32 center_x,
    vx_uint32 center_y, vx_uint32 left, vx_uint32 top, vx_uint32 right,
    vx_uint32 bottom, vx_uint8 *mask, vx_uint8 *destination) {
...
vx_status vxNonLinearFilter(vx_scalar function, vx_image src, vx_matrix mask,
                            vx_image dst, vx_border_t *border) {
  vx_uint32 y, x;
  void *src_base = NULL;
  void *dst_base = NULL;
  ...
  if (status == VX_SUCCESS) {
    ...
    if (border->mode == VX_BORDER_UNDEFINED) {
      ...
      vxAlterRectangle(&rect, (vx_int32)rx0, (vx_int32)ry0, -(vx_int32)rx1,
                       -(vx_int32)ry1);
    }
    ...
    for (y = low_y; y < high_y; y++) {
      for (x = low_x; x < high_x; x++) {
        ...
        vx_int32 count = (vx_int32)readMaskedRectangle_U8(
            src_base, &src_addr, border, VX_DF_IMAGE_U8, x, y, (vx_uint32)rx0,
            (vx_uint32)ry0, (vx_uint32)rx1, (vx_uint32)ry1, m, v);
