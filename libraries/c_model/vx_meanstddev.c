...
static vx_status VX_CALLBACK vxMeanStdDevKernel(vx_node node,
...
static vx_status VX_CALLBACK vxMeanStdDevInputValidator(vx_node node,
                                                        vx_uint32 index) {
...
static vx_status VX_CALLBACK vxMeanStdDevOutputValidator(
...
vx_kernel_description_t mean_stddev_kernel = {
    ...
    vxMeanStdDevKernel,
    mean_stddev_kernel_params,
    dimof(mean_stddev_kernel_params),
    NULL,
