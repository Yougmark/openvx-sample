...
static vx_status VX_CALLBACK vxErode3x3Kernel(vx_node node,
...
static vx_status VX_CALLBACK vxDilate3x3Kernel(vx_node node,
                                               const vx_reference *parameters,
                                               vx_uint32 num) {
  vx_status status = VX_ERROR_INVALID_PARAMETERS;
  if (num == 2) {
...
static vx_status VX_CALLBACK vxMorphologyInputValidator(vx_node node,
                                                        vx_uint32 index) {
  vx_status status = VX_ERROR_INVALID_PARAMETERS;
  if (index == 0) {
    vx_image input = 0;
...
static vx_status VX_CALLBACK vxMorphologyOutputValidator(
...
vx_kernel_description_t erode3x3_kernel = {
    ...
    vxErode3x3Kernel,
    morphology_kernel_params,
    dimof(morphology_kernel_params),
    NULL,
