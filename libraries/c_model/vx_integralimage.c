...
static vx_status VX_CALLBACK vxIntegralImageKernel(
...
static vx_status VX_CALLBACK vxIntegralInputValidator(vx_node node,
                                                      vx_uint32 index) {
...
static vx_status VX_CALLBACK vxIntegralOutputValidator(vx_node node,
                                                       vx_uint32 index,
...
vx_kernel_description_t integral_image_kernel = {
    ...
    integral_image_kernel_params,
    dimof(integral_image_kernel_params),
    NULL,
